...
// less than the size passed to flink()
...
void encryptData(unsigned char *a, int size){
	int i =0;
	for(i =0; i<size; i++){
		*a = (((int)a)+1)%256;
		a++;	
...
void decryptData(unsigned char *a, int size){
	int i =0;
	for(i =size; i>0; i--){
		*a = (((int)a)-1)%256;
		a++;	
